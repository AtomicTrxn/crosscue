...
Future<AvatarChoice?> showAvatarPickerSheet(
  ...
  return showCbSheet<AvatarChoice>(context, title: 'Choose your avatar',
      builder: (ctx) {
          ...
          children: [
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Icon(Icons.info_outline_rounded,
                  size: 14, color: AppColors.onSurface3(ctx)),
              const SizedBox(width: 6),
              Expanded(
                  child: Text(
                      'Pick a look or add your own photo — shown to friends on your boards.',
                      style: AppTextStyles.caption.copyWith(
                          color: AppColors.onSurface3(ctx), height: 1.45))),
            ]),
            const SizedBox(height: 18),
            FilledButton(
              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                            color: AppColors.dialogSurface(context), width: 2)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: AppColors.onSurface3(context).withOpacity(0.5),
            width: 2,
            style: BorderStyle.solid),
      ),
      child: Icon(Icons.add_a_photo_outlined,
          size: 22, color: AppColors.primary(context)),
    );
  }
}
