...
abstract final class SampleData {
  ...
  static const boards = <Board>[
    Board(
      ...
      playerCount: 12,
      myWeekly: Standing(rank: 1, outOf: 12, cleanSolves: 11, avgClean: '3:52'),
    ),
    Board(
      id: 'b2',
      name: 'Friday Night Crew',
      playerCount: 8,
      myWeekly: Standing(rank: 2, outOf: 8, cleanSolves: 9, avgClean: '4:18'),
    ),
    Board(
      id: 'b3',
      name: 'Office Puzzlers',
      playerCount: 5,
      myWeekly: Standing(rank: 4, outOf: 5, cleanSolves: 6, avgClean: '5:40'),
    ),
    Board(
      id: 'b4',
      name: 'Sunday Solvers',
      playerCount: 3,
      myWeekly: Standing(rank: 2, outOf: 3, cleanSolves: 7, avgClean: '4:33'),
    ),
    Board(
      id: 'b5',
      name: 'Mum & Dad',
      playerCount: 2,
      myWeekly: Standing(rank: 1, outOf: 2, cleanSolves: 5, avgClean: '6:02'),
    ),
  ];
  ...
  static const weeklyLeaderboard = <LeaderboardEntry>[
    ...
    LeaderboardEntry(
      ...
      player: Player(
        id: 'p3',
        displayName: 'Sam',
        avatar: PlayerAvatar.silhouette(2),
      ),
    ),
    LeaderboardEntry(
      rank: 4,
